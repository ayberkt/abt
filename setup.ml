...
(* OASIS_START *)
(* DO NOT EDIT (digest: f8d695960d1adb0293a7e10a46b33335) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/ayberkt/abt";
          bugreports = None;
          synopsis = "OCaml port of CMU's abstract binding trees.";
          description =
            Some
              [OASISText.Para "OCaml port of CMU's abstract binding trees."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Variable"; "Operator"; "Abt"; "Abt_util"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\238\001\145\201\220\007_\247\004\rb\193\2156%\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
